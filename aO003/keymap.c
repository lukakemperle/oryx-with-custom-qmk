...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_AUDIO_VOL_DOWN,KC_AUDIO_MUTE,  KC_AUDIO_VOL_UP,KC_TRANSPARENT,                                 KC_TRANSPARENT, LALT(KC_LEFT),  KC_DELETE,      LALT(KC_RIGHT), KC_BSPC,        DUAL_FUNC_0,    
    KC_ENTER,       KC_LEFT_GUI,    KC_LEFT_ALT,    KC_LEFT_SHIFT,  KC_LEFT_CTRL,   LGUI(LCTL(KC_LBRC)),                                KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_ENTER,       KC_RIGHT,       
    KC_TRANSPARENT, KC_ENTER,       LGUI(KC_Z),     KC_TRANSPARENT, KC_F13,         LGUI(LCTL(KC_SPACE)),                                RGUI(KC_BSPC),  LALT(KC_BSPC),  LALT(KC_DELETE),ST_MACRO_2,     ST_MACRO_3,     KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LALT(LCTL(KC_F20)),KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, RALT(KC_F20),   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, RSFT(KC_F19),   RCTL(KC_F19),   LALT(LCTL(LSFT(KC_F20))),KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_F19,         LALT(LCTL(KC_F19)),LALT(LGUI(LCTL(KC_F19))),LCTL(LSFT(KC_F19)),LALT(LSFT(KC_F19)),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 RALT(RGUI(KC_F19)),LALT(LSFT(KC_F20)),LCTL(LSFT(KC_F20)),RGUI(RSFT(KC_F19)),KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [8] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LALT(LCTL(LSFT(KC_F19))),KC_Q,           KC_TRANSPARENT, KC_TRANSPARENT, KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,        
    TO(0),          KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOTE,       
    KC_TRANSPARENT, KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT, 
                                                    KC_SPACE,       LALT(LCTL(LSFT(KC_F19))),                                KC_TRANSPARENT, KC_Z
  ),
  [9] = LAYOUT_voyager(
    ...
    KC_LEFT_ALT,    KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_RIGHT_ALT,   
    KC_LEFT_GUI,    KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_GUI,   
                                                    KC_SPACE,       KC_TRANSPARENT,                                 KC_ESCAPE,      KC_SPACE
  ),
  [10] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [1] = { {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {0,0,0}, {0,0,0}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125}, {162,134,125} },
    ...
    [9] = { {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {146,255,255}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {192,214,137}, {146,255,255}, {192,214,137} },
  ...
  case QK_MODS ... QK_MODS_MAX:
    ...
    case DUAL_FUNC_0:
      if (record->tap.count > 0) {
        if (record->event.pressed) {
          register_code16(LALT(LGUI(LCTL(LSFT(KC_BSLS)))));
        } else {
          unregister_code16(LALT(LGUI(LCTL(LSFT(KC_BSLS)))));
        }
      } else {
        if (record->event.pressed) {
